...
struct task_struct *runq_choose(struct runq *rq, struct task_struct *p, bool find_lowest_priority);
struct task_struct *runq_choose_from(struct runq *rq, int idx, struct task_struct *p, bool find_lowest_priority);
